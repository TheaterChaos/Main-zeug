...
return {
    ...
    execute=function(target)
        ...
        if config.vehicles then
            ...
            textline = textline..num_deleted_vehicles.." vehicles"
        end
        if config.objects or config.peds or config.vehicles then
            util.toast(textline)
        end
    end,
